...
int main(int argc, char **argv) {
        ...
        while ((opt = getopt(argc, argv, "b:df:cFhpqi:l:m:n:o:P:r:st:u:S:")) != -1) {
                switch (opt) {
                        case 'b': use_dumpfile = optarg; break;
			case 'c': show_post_body = 1; break;
